...
hf_cache_dir = "C:\\FacultateAnul2\\Proiecte\\NanoGpt\\edu_fineweb10B"
os.makedirs(hf_cache_dir, exist_ok=True) # ensure the directory exists

# download the dataset into the specified cache directory
...
# tokenize all documents sequentially and write output shards, each of shard_size tokens (last shard has remainder)
shard_index = 0
